...
global_variables() {
    ...
    # Blog title
    global_title="AlxiKan's static blog"
    # The typical subtitle for each blog
    global_description="A blog for SW"
    # The public base URL for this blog
    global_url="http://example.com/blog"

    # Your name
    global_author="Alexios Kantartzis"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="http://github.com/AlxiKan" 
    # Your email
    global_email="alexikan98@gmail.com"
